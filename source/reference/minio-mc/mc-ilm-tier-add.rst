...
The :mc:`mc ilm tier add` command creates a new remote storage tier to a supported S3-compatible service for MinIO :ref:`Lifecycle Management: Object Transition ("Tiering")<minio-lifecycle-management-expiration>`. 
...
.. mc-cmd:: TARGET
   ...
   Rules on this deployment use the new tier to transition objects from this deployment to a remote location.
